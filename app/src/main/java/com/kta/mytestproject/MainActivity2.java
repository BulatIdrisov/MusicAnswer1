...
//        // Получаем объект SharedPreferences
        ...
        stop.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (my_music.isPlaying()) {
                    my_music.stop();
                    my_music.release();
                    my_music = MediaPlayer.create(MainActivity2.this, R.raw.music);
                }
            }
        });
        ...
        stop2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (my_music1.isPlaying()) {
                    my_music1.stop();
                    my_music1.release();
                    my_music1 = MediaPlayer.create(MainActivity2.this, R.raw.music2);
                }
            }
        });
        ...
        stop3.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (my_music2.isPlaying()) {
                    my_music2.stop();
                    my_music2.release();
                    my_music2 = MediaPlayer.create(MainActivity2.this, R.raw.music3);
                }
            }
        });

        my_music = MediaPlayer.create(this, R.raw.music4);
        ...
        my_music1 = MediaPlayer.create(this, R.raw.music5);
        ...
        my_music2 = MediaPlayer.create(this, R.raw.music6);
    ...
    private void saveScoreToPreferences() {
        ...
        //dataManager.insertPlayerData(ratingPrefs.getString("playerName", ""), score);
        dataManager.insertPlayerData(ratingPrefs.getString("playerName", ""), score, true);
    ...
    public void onBackPressed(){
        ...
        try {
            Intent intent = new Intent(MainActivity2.this, lvls.class);
